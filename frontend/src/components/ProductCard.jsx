const ProductCard = ({ title, price, category, image, description }) => {
  ...
  return (
    <div
      ...
      // Xử lý hiệu ứng Hover bằng sự kiện JavaScript theo giáo trình
      onMouseEnter={(e) => {
    ...
    >
      {/* Badge Premium (Thao tác tùy chọn nâng cao) */}
      {isPremium && (
